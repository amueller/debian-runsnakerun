...
assert string.match('"this\\u0000"').group(
    'string') == "this\\u0000", string.match('"this\\u0000"').group('string')

assert integer.match('23').group('int') == '23'
assert intlist.match('[1, 2,3,4]').group('list') == '1, 2,3,4'
assert intlist.match('[139828625414688, 70572696, 52870672, 40989336]').group(
    'list') == '139828625414688, 70572696, 52870672, 40989336'
