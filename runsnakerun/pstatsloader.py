    ...
    def recursive_distinct(self, already_done=None, attribute='children'):
        ...
        for child in getattr(self, attribute, ()):
            if child not in already_done:
                ...
                yield child
                for descendent in child.recursive_distinct(already_done=already_done,
                                                           attribute=attribute):
                    yield descendent
...
class PStatRow(BaseStat):
    ...
    def __repr__(self):
        return 'PStatRow( %r,%r,%r,%r, %s )' % (self.directory, self.filename,
...
class PStatGroup(BaseStat):
    ...
    def __repr__(self):
        return '%s( %r,%r,%s )' % (self.__class__.__name__, self.directory,
